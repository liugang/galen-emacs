...
;; use function `eal-eval-by-modes', `eal-eval-by-maps',

;; `define-key'  more convenient  use  function `eal-define-key',
;; `eal-define-key', `eal-define-keys-commonly'.

;; For more details, see article http://emacser.com/eval-after-load.htm
