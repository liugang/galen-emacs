...
;; Version: $Id: config-ocaml.el,v 0.0 2010/11/20 07:48:55 ott Exp $
;; Keywords:
;; Requirements:
...
(require 'tuareg)
(defun galen.gang.liu/tuareg-hook ()
  (turn-on-eldoc-mode)
...
(add-hook 'tuareg-mode-hook 'galen.gang.liu/tuareg-hook)
(add-hook 'tuareg-mode-hook 'galen.gang.liu/common-hook)
(add-hook 'tuareg-mode-hook 'galen.gang.liu/show-prog-keywords)
