...
(defun galen.gang.liu/clojure-mode-hook ()
...
(add-hook 'clojure-mode-hook 'galen.gang.liu/common-hook)
(add-hook 'clojure-mode-hook 'galen.gang.liu/show-prog-keywords)
(add-hook 'clojure-mode-hook 'galen.gang.liu/clojure-mode-hook)
...
(defun galen.gang.liu/clojure-slime-conn-hook ()
...
(add-hook 'slime-connected-hook 'galen.gang.liu/clojure-slime-conn-hook)
