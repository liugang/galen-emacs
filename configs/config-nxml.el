;;; config-nxml.el --- customisation of nXML-mode
...
(defun galen.gang.liu/nxml-mode-hook ()
...
(add-hook 'nxml-mode-hook 'galen.gang.liu/nxml-mode-hook)
(add-hook 'nxml-mode-hook 'galen.gang.liu/common-hook)
