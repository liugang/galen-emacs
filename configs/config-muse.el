;;; config-muse.el --- -*- coding: utf-8 -*-

;; Copyright (C) 2006 Galen
;;
      ...
      `(("personal-notes"
        ...
        ("my-page-project"
         ...
         (:base "my-page-pdf"
                ...
                :include "/galen.gang.liu-cv-en[^/]*$")
         (:base "my-page-pdf"
                :path "~/projects/my-page-muse/ru"
                :include "/galen.gang.liu-cv-ru[^/]*$"))
        ))
...
(defun galen.gang.liu/muse-mode-hook ()
  (setq auto-fill-mode t)
  (footnote-mode 1)
  )
(add-hook 'muse-mode-hook 'galen.gang.liu/muse-mode-hook)
(add-hook 'muse-mode-hook 'galen.gang.liu/common-hook)
(add-hook 'muse-mode-hook 'galen.gang.liu/show-prog-keywords)
...
(defun galen.gang.liu/muse-replace-text (from to)
  (save-excursion
...
(defun galen.gang.liu/muse-convert-docbook ()
  (interactive)
  (mapcar (lambda (x) (galen.gang.liu/muse-replace-text (car x) (cdr x)))
...
(defun galen.gang.liu/blorg-publish-file (fname)
  (save-excursion
...
(defun muse-mp-publish-hook (data)
  (if (string-equal (car data) "my-page-project")
      (progn
        (galen.gang.liu/blorg-publish-file "~/projects/my-page-muse/ru/news/news.org")
        (galen.gang.liu/blorg-publish-file "~/projects/my-page-muse/en/news/news.org"))))
