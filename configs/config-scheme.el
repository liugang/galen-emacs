...
(defun galen.gang.liu/scheme-mode-hook ()
...
(add-hook 'scheme-mode-hook 'galen.gang.liu/scheme-mode-hook)
(add-hook 'scheme-mode-hook 'galen.gang.liu/common-hook)
(add-hook 'scheme-mode-hook 'galen.gang.liu/show-prog-keywords)
