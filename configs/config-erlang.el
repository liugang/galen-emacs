...
(defun galen.gang.liu/erlang-mode-hook ()
...
(add-hook 'erlang-mode-hook 'galen.gang.liu/erlang-mode-hook)
(add-hook 'erlang-mode-hook 'galen.gang.liu/common-hook)
(add-hook 'erlang-mode-hook 'galen.gang.liu/show-prog-keywords)
