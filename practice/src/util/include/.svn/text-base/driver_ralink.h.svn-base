...
#undef  ULONG           
//#define ULONG           u32
#define ULONG           u32 /* 32-bit in 32-bit CPU or 64-bit in 64-bit CPU */
#define USHORT          u16
...
typedef struct PACKED _NDIS_802_11_KEY// PACKED by peter 0917
{
...
{
    UINT   SsidLength;         // length of SSID field below, in bytes;// peter 0828 : INT ===> UINT
                                // this can be zero.
...
void wireless_driver_ralink_set_scan_completed_cb(void (*cb)(void *user_data), void *user_data);
void wireless_driver_ralink_scan_completed(void);
...
struct SITE_OBJ *wireless_driver_ralink_get_scan_results(int *cnt, WIRELESS_MODE mode);
